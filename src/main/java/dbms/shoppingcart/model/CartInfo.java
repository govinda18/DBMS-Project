...
public class CartInfo {
    ...
    private CartLineInfo findLineByCode(String code) {
        for (CartLineInfo line : this.cartLines) {
            if (line.getItemInfo().getCode().equals(code)) {
                return line;
            }
        }
        return null;
    ...
    public void addItem(ItemInfo itemInfo, int quantity) {
        CartLineInfo line = this.findLineByCode(itemInfo.getCode());
    ...
    public void updateQuantity(CartInfo cartForm) {
        if (cartForm != null) {
            ...
            for (CartLineInfo line : lines) {
                this.updateItem(line.getItemInfo().getCode(), line.getQuantity());
            }
        }
